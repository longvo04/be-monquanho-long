...
const UserSchema = new mongoose.Schema({
    email: { type: String, unique: true, sparse: true }, // Email user, duy nhất, bắt buộc
    ...
    phone: { type: String, default: null, unique: true, sparse: true } // Số điện thoại (có thể null)
});
