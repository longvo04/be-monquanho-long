...
const CommunityCommentsSchema = new mongoose.Schema({
    post_id: { type: mongoose.Schema.Types.ObjectId, ref: "CommunityPosts", required: true }, // Bài đăng mà bình luận thuộc về
    ...
    parent_id: { type: mongoose.Schema.Types.ObjectId, ref: "CommunityComments", default: null }, // ID bình luận cha nếu là trả lời, null nếu là bình luận gốc
